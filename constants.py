...
# Scraper Timeouts
# =============================================================================
# Values are milliseconds because Playwright timeout arguments use ms.
...
# LLM Retry
# =============================================================================
# Shared by llm.py for provider API retries.

RETRY_ATTEMPTS    = 4    # total LLM API call attempts before giving up
